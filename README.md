...
The chess engine used by the computer is rudimentary in nature. Located in file Engine.js, it is aggressive and lacks foresight. That said, the interface between the chess engine and the other parts of the system is designed to be obvious and extensible. Perhaps some other developer will insert a better engine. 
